...
int main() {
    ...
    while (1) {
        ch = menu();
        switch (ch) {
            case 1: display(data, num_element);
                    printf("Sum = %d\n", sum_array(data, num_element)); break;
            case 2: display(data, num_element);
                    printf("Average = %.2f\n", avg_array(data, num_element)); break;
            case 3: display(data, num_element);
                    printf("Minimum = %d\n", min_array(data, num_element)); break;
            case 4: display(data, num_element);
                    printf("Maximum = %d\n", max_array(data, num_element)); break;
            case 5: display(data, num_element); break;
            case 6: exit(0);
